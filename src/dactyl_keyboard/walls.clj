...
(def back-convex-thumb-wall-1
  (wall-brace thumb-mr-place 0 (- wall-multiplier) web-post-br thumb-tr-place 0 (- wall-multiplier) thumb-post-br))
(def back-convex-thumb-wall-2
  (if trackball-enabled
